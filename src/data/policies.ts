...
export const policies: PolicyDetail[] = [
  ...
  },
  {
    ...
    oldFileName: "etc_support_medical_benefit.html",
    categorySlug: "etc-support",
    categoryName: "기타 취약계층 지원",
    title: "국민기초생활보장 의료급여 (1종·2종 본인부담금 면제/경감)",
    shortTitle: "기초생활 의료급여",
    summary: "생활유지 능력이 없거나 어려운 국민의 질병, 부상 등에 대해 진찰, 검사, 치료 등 의료서비스를 거의 무료로 제공합니다.",
    targetAudience: "기준중위소득 40% 이하 수급권자",
    benefitSummary: "1종(본인부담금 0원~1천원 수준), 2종(본인부담률 10~14%)",
    keyAmount: "의료비 최대 95~100% 면제",
    badge: "의료비 보장",
    eligibility: [
      "소득인정액이 기준중위소득 40% 이하인 가구",
      "근로무능력자로만 구성된 세대(1종) 또는 근로능력자가 있는 세대(2종)"
    ],
    benefits: [
      "1종 수급권자: 외래 1,000~2,000원, 입원비 100% 전액 면제",
      "2종 수급권자: 외래 1,000원~14%, 입원비 본인부담 10%",
      "임신·출산 진료비, 틀니, 임플란트, 장애인보조기기 지원"
    ],
    howToApply: ["주민센터 복지과 방문 신청"],
  ...
  },
  {
    ...
    oldFileName: "etc_support_housing_benefit.html",
    categorySlug: "etc-support",
    categoryName: "기타 취약계층 지원",
    title: "국민기초생활보장 주거급여 (임차료 및 수선유지비 지원)",
    shortTitle: "기초생활 주거급여",
    summary: "소득인정액이 기준중위소득 48% 이하인 저소득 가구에 매월 전월세 임차료를 현금 지급하고 자가가구는 집수리를 지원합니다.",
    targetAudience: "소득인정액이 기준중위소득 48% 이하인 무주택 임차가구 및 유주택 자가가구",
    benefitSummary: "서울 4인 기준 매월 최대 52.7만원 전월세 임차급여 지원",
    keyAmount: "매월 임대료 실비 지원",
    badge: "주거 안정",
    eligibility: ["기준중위소득 48% 이하 (부양의무자 기준 전면 폐지)"],
    benefits: [
  ...
  },
  {
    ...
    oldFileName: "etc_support_education_benefit.html",
    categorySlug: "etc-support",
    categoryName: "기타 취약계층 지원",
    title: "국민기초생활보장 교육급여 (초·중·고 교육활동지원비 바우처)",
    shortTitle: "기초생활 교육급여",
    summary: "저소득층 초·중·고등학생에게 교육활동지원비 바우처를 연 1회 일괄 지급하여 균등한 교육 기회를 보장합니다.",
    targetAudience: "기준중위소득 50% 이하 초·중·고 재학 자녀를 둔 가구",
    benefitSummary: "초등학생 46.1만원, 중학생 65.4만원, 고등학생 72.7만원 바우처",
    keyAmount: "연 최대 72.7만원",
    badge: "학습 지원",
    eligibility: ["소득인정액 기준중위소득 50% 이하인 초·중·고 학생 가구"],
    benefits: [
      "초등학생: 연 461,000원",
      "중학생: 연 654,000원",
      "고등학생: 연 727,000원 (고교 교과서대금 및 입학금·수업료 전액 면제)"
    ],
    howToApply: ["복지로 온라인 또는 주민센터"],
  ...
  {
    slug: "next-lower-income-class",
    oldFileName: "etc_support_next_lower_income_class.html",
    categorySlug: "etc-support",
    categoryName: "기타 취약계층 지원",
    title: "차상위계층 확인제도 및 정부 감면 혜택 총정리",
    shortTitle: "차상위계층 종합 혜택",
    summary: "기초생활수급자는 아니지만 소득인정액이 기준중위소득 50% 이하인 잠재적 빈곤가구를 대상으로 다양한 공공요금 및 복지 혜택을 제공합니다.",
    targetAudience: "소득인정액이 기준중위소득 50% 이하인 가구",
    benefitSummary: "문화누리카드(연 13만원), 통신비 감면, 급식비 지원 등",
    keyAmount: "다양한 감면 혜택",
    badge: "생활비 감면",
    eligibility: ["기준중위소득 50% 이하 (고정재산 및 소득 평가)"],
    benefits: [
      "통신비 감면: 이동전화 기본료 월 11,000원 감면 및 통화료 35% 감면",
      "전기·가스 공공요금 월 최대 수만원 정액 할인",
      "통합문화이용권(문화누리카드): 1인당 연 130,000원 지원"
    ],
    howToApply: ["주민센터 방문 신청"],
  ...
  {
    slug: "emergency-welfare",
    oldFileName: "etc_support_emergency_welfare.html",
    categorySlug: "etc-support",
    categoryName: "기타 취약계층 지원",
    title: "위기가구 긴급복지지원제도 (생계·의료·주거 긴급 지원)",
    shortTitle: "긴급복지지원제도",
    summary: "실직, 중한 질병, 주소득자 사망 등 갑작스러운 위기상황으로 생계유지가 곤란한 저소득 가구에 신속하게 현금 및 의료비를 긴급 지원합니다.",
    targetAudience: "위기상황 발생으로 생계가 곤란한 가구 (기준중위소득 75% 이하)",
    benefitSummary: "4인 가구 기준 월 183만원 생계지원 (최대 6회), 의료비 최대 300만원",
    keyAmount: "최대 300만원 즉시 지원",
    badge: "위기 극복",
    eligibility: [
      "주소득자의 사망, 가출, 행방불명, 구금 등으로 소득 상실",
      "중한 질병 또는 부상을 당한 경우, 실직, 화재, 가정폭력 등",
      "기준중위소득 75% 이하 및 금융재산 600만원 이하 (주거지원은 800만원 이하)"
    ],
    benefits: [
      "긴급 생계지원: 1인 가구 월 71.3만원, 4인 가구 월 183.3만원",
      "긴급 의료지원: 회당 최대 300만원 한도 실비 지원",
      "긴급 주거지원: 대도시 기준 월 최대 66.2만원 임시 거처 지원"
    ],
    howToApply: ["보건복지상담센터(국번없이 129) 전화 신청 또는 시·군·구청 복지과"],
  ...
  {
    slug: "newlywed-purchase-loan",
    oldFileName: "housing_support_newlywed_purchase_loan.html",
    categorySlug: "housing-support",
    categoryName: "신혼부부·출산가구 주거 지원",
    title: "신혼부부 전용 디딤돌 대출 (내집마련 구입자금 연 2.15%~)",
    shortTitle: "신혼부부 디딤돌 대출",
    summary: "혼인 7년 이내 신혼부부에게 연 2.15%~3.0%의 저금리로 최대 4억원까지 주택구입자금을 대출해 드립니다.",
    targetAudience: "부부합산 연소득 8,500만원 이하, 순자산 4.69억원 이하 무주택 신혼부부",
    benefitSummary: "최대 4억원 대출, 우대금리 적용 시 최저 연 1.5%대",
    keyAmount: "최대 4억원 (초저금리)",
    badge: "구입자금 대출",
    eligibility: ["혼인기간 7년 이내 또는 3개월 이내 결혼예정자", "주택 매매가 6억원 이하, 전용면적 85㎡ 이하"],
    benefits: ["대출한도: 최대 4억원 (LTV 80%)", "금리: 연 2.15% ~ 3.00%", "만기: 10년, 15년, 20년, 30년"],
    howToApply: ["기금e든든(enhuf.molit.go.kr) 또는 5대 수탁은행"],
  ...
  },
  {
    ...
    oldFileName: "housing_support_newlywed_jeonse_loan.html",
    categorySlug: "housing-support",
    categoryName: "신혼부부·출산가구 주거 지원",
    title: "신혼부부 전용 버팀목 전세자금 대출 (최대 3억원 지원)",
    shortTitle: "신혼부부 버팀목 전세대출",
    summary: "신혼부부의 전세보증금 부담을 덜어주기 위해 수도권 최대 3억원까지 연 1.5%~2.7% 저금리로 전세자금을 지원합니다.",
    targetAudience: "부부합산 연소득 7,500만원 이하 무주택 신혼부부",
    benefitSummary: "수도권 최대 3억원, 지방 최대 2억원 (보증금 80% 이내)",
    keyAmount: "최대 3억원 (연 1.5%~)",
    badge: "전세자금 대출",
    eligibility: ["혼인 7년 이내 무주택 세대주", "임차보증금 수도권 4억원(지방 3억원) 이하"],
    benefits: ["금리: 연 1.5% ~ 2.7%", "이용기간: 2년 (최장 10년 연장 가능)"],
    howToApply: ["기금e든든 온라인 또는 취급은행"],
  ...
  },
  {
    ...
    oldFileName: "work_family_family_care_leave.html",
    categorySlug: "work-family",
    categoryName: "일·가정 양립 지원",
    title: "가족돌봄휴가 및 가족돌봄휴직 제도",
    shortTitle: "가족돌봄휴가 (연 10일)",
    summary: "가족의 질병, 사고, 노령 또는 자녀 양육으로 긴급하게 돌봄이 필요한 경우 연간 최대 10일의 휴가 및 최대 90일의 휴직을 보장합니다.",
    targetAudience: "조부모, 부모, 배우자, 자녀 등의 돌봄이 필요한 근로자",
    benefitSummary: "가족돌봄휴가 연간 최대 10일 (1일 단위 사용), 가족돌봄휴직 연간 최대 90일",
    keyAmount: "연간 최대 10일/90일",
    badge: "긴급 돌봄",
    eligibility: ["모든 사업장 근로자", "사업주는 정당한 사유 없이 거부 불가"],
    benefits: ["가족돌봄휴가: 연 10일 (분할 사용 가능)", "가족돌봄휴직: 연 90일 (1회 30일 이상)"],
    howToApply: ["회사 인사팀에 휴가 시작일 및 사유 서면 제출"],
  ...
  {
    slug: "multi-child-childrearing-education",
    oldFileName: "multi_child_childrearing_education_support.html",
    categorySlug: "multi-child",
    categoryName: "다자녀 가구 지원",
    title: "다자녀 국가장학금 및 대학등록금 전액 지원 (셋째아 이상 등록금 100%)",
    shortTitle: "다자녀 국가장학금",
    summary: "다자녀(3자녀 이상, 일부 2자녀) 가구의 대학생 자녀에게 국가장학금을 우대 지원하며, 셋째 자녀부터는 소득 8구간 이하 시 등록금 전액을 지원합니다.",
    targetAudience: "대한민국 국적의 다자녀 가구 대학생 (학자금 지원 8구간 이하)",
    benefitSummary: "첫째·둘째 연 최대 450만~570만원, 셋째아 이상 등록금 전액 100% 지원",
    keyAmount: "셋째아 이상 등록금 전액",
    badge: "교육비 전액",
    eligibility: ["만 19세 미만 자녀 3명 이상 가구의 대학생", "학자금 지원구간 8구간 이하, 직전학기 12학점 이수 및 B학점 이상"],
    benefits: [
      "1~3구간: 첫째·둘째 연 570만원, 셋째 이상 등록금 전액 지원",
      "4~8구간: 첫째·둘째 연 450만원, 셋째 이상 등록금 전액 지원"
    ],
    howToApply: ["한국장학재단(kosaf.go.kr) 웹/앱 온라인 신청"],
